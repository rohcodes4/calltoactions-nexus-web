        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {processes.map((process, index) => (
            <motion.div 
              ...
              className="glass-card p-6 rounded-lg relative border border-white/5 group hover:border-agency-purple/30 transition-all duration-300"
            >
              <div className="absolute -top-3 -right-3 bg-gradient-to-r from-agency-purple to-agency-blue text-white w-10 h-10 rounded-full flex items-center justify-center font-bold">
                {process.step}
              </div>
              <div className="flex items-center mb-4">
                <div className="w-10 h-10 rounded-lg bg-agency-purple/10 flex items-center justify-center mr-3">
                  {process.icon}
                </div>
