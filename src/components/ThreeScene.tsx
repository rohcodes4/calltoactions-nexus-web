...
const FloatingText = ({ position = [0, 0, 0], text = "CallToActions" }) => {
...
const ParticleField = ({ count = 100 }) => {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < count * 3; i += 3) {
      randomPositions[i] = (Math.random() - 0.5) * 15;
      randomPositions[i+1] = (Math.random() - 0.5) * 15;
      randomPositions[i+2] = (Math.random() - 0.5) * 15;
    }
